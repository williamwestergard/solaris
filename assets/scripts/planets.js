...
function planetInformation(data) {
  ...
  function planetsIndex() {
    ...
    //Solen
    if (currentIndex === 0) {
      document.getElementById("sun-planet-css-container").style.display =
        "block";
      document.getElementById("planet-frame-rotation-upper-right").style.width =
        "15.5vw";
    } else {
      document.getElementById("sun-planet-css-container").style.display =
        "none";
    ...
    //Merkurkius
    if (currentIndex === 1) {
      document.getElementById("merkurius-planet-css-container").style.display =
        "block";
    } else {
      document.getElementById("merkurius-planet-css-container").style.display =
        "none";
    ...
    //Venus
    if (currentIndex === 2) {
      document.getElementById("venus-planet-css-container").style.display =
        "block";
    } else {
      document.getElementById("venus-planet-css-container").style.display =
        "none";
    ...
    //Jorden
    if (currentIndex === 3) {
      document.getElementById("jorden-planet-css-container").style.display =
        "block";
    } else {
      document.getElementById("jorden-planet-css-container").style.display =
        "none";
    ...
    //Mars
    if (currentIndex === 4) {
      document.getElementById("mars-planet-css-container").style.display =
        "block";
    } else {
      document.getElementById("mars-planet-css-container").style.display =
        "none";
    ...
    //Jupiter
    if (currentIndex === 5) {
      document.getElementById("jupiter-planet-css-container").style.display =
        "block";
    } else {
      document.getElementById("jupiter-planet-css-container").style.display =
        "none";
    ...
    //Saturnus
    if (currentIndex === 6) {
      document.getElementById("saturnus-planet-css-container").style.display =
        "block";
    } else {
      document.getElementById("saturnus-planet-css-container").style.display =
        "none";
    ...
    //Uranus
    if (currentIndex === 7) {
      document.getElementById("uranus-planet-css-container").style.display =
        "block";
    } else {
      document.getElementById("uranus-planet-css-container").style.display =
        "none";
    ...
    //Neptunus
    if (currentIndex === 8) {
      document.getElementById("neptunus-planet-css-container").style.display =
        "block";
    } else {
      document.getElementById("neptunus-planet-css-container").style.display =
        "none";
    ...
    function carouselActive() {
      ...
      if (currentIndex === 1) {
        ...
        document.getElementById("carousel-merkurius").style.pointerEvents =
          "none";
      } else {
      ...
      if (currentIndex === 5) {
        ...
        document.getElementById("carousel-jupiter").style.pointerEvents =
          "none";
      } else {
      ...
      if (currentIndex === 6) {
        ...
        document.getElementById("carousel-saturnus").style.pointerEvents =
          "none";
      } else {
      ...
      if (currentIndex === 8) {
        ...
        document.getElementById("carousel-neptunus").style.pointerEvents =
          "none";
      } else {
    ...
    // Planetens distans
    planetDistance.innerHTML = `<span class="strong-distance"> Distans: </span>${planetInfo.distance}</span>`;
    // Planetens omkrets
    planetCircumference.innerHTML = `<span class="strong-distance"> Omkrets: </span>${planetInfo.circumference}</span>`;
    // Planetens månar
    planetMoons.innerHTML = `<span class="strong"> Månar: </span><span class="moons-style">${planetInfo.moons}</span>`;
    ...
    let moonContainer = document.getElementById(
      "distance-moons-info-container"
    );
    let showAll = false;
    ...
    function renderMoons() {
      ...
      let moonsToShow = showAll
        ? planetInfo.moons
        : planetInfo.moons.slice(0, 3);
    ...
    planetOrbitalPeriod.innerHTML = `<span class="orbital-number">${planetInfo.orbitalPeriod}</span> <br> 
    ...
    planetRotation.innerHTML = ` <span class="rotation-text">Rotation </span> <span class="rotation-numbers-border">${rotationNumbers}</span>`;

    let tempDay = planetInfo.temp.day;
    let tempNight = planetInfo.temp.night;
    planetTemperature.innerHTML = `<span class="strong temp">Temperatur <br><br> </span>
    ...
    if (planetInfo.type === "star") {
      let starOrPlanet = (document.getElementById(
        "star-or-planet"
      ).innerHTML = `<span style="font-weight:200;"> Stjärna</span>`);
      planetType + starOrPlanet;
    } else {
      let starOrPlanet = (document.getElementById(
        "star-or-planet"
      ).innerHTML = `<span style="font-weight:200;"> Planet</span>`);
      planetType + starOrPlanet;
    }
  }
  ...
  document
    .getElementById("carousel-merkurius")
    .addEventListener("click", merkurius);
  ...
  document
    .getElementById("carousel-jupiter")
    .addEventListener("click", jupiter);
  ...
  document
    .getElementById("carousel-saturnus")
    .addEventListener("click", saturnus);
  ...
  document
    .getElementById("carousel-neptunus")
    .addEventListener("click", neptunus);
  ...
  document
    .getElementById("menu-arrow-left")
    .addEventListener("click", moveLeft);
  document
    .getElementById("menu-arrow-right")
    .addEventListener("click", moveRight);

  // Pilarna nere till höger kopplar ihop till menyn för att bläddra listan.
  document
    .querySelector(".next-button-carousel")
    .addEventListener("click", moveRightNextButton);
  document
    .querySelector(".prev-button-carousel")
    .addEventListener("click", moveLeft);
